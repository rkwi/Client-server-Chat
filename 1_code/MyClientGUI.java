...
public class MyClientGUI extends javax.swing.JFrame {
    static MyClient client = new MyClient(1026);
    /**
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        client.write(RSA.encrypt(jTextField1.getText()));
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            if (client.read()) {
                jTextArea1.append("Server: "+client.getText()+"\n");
                jTextArea1.append("Server: "+RSA.decrypt(client.getText())+"\n");
            }
        }
